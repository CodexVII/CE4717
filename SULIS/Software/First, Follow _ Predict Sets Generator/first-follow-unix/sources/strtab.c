...
/*      from store.                                                          */
/*                                                                           */ 
/*      Three routines are provided by this module.                          */
/*                                                                           */ 
/*          "AddString" -- this is the routine which builds a new string     */
/*          character by character in the string table.                      */
/*                                                                           */ 
...
/*---------------------------------------------------------------------------*/
/*                                                                           */
/*      Function prototypes for routines private to the module               */
/*                                                                           */
/*---------------------------------------------------------------------------*/
...
/*      AddString                                                            */
/*                                                                           */
/*      Inserts a new string in the string table. Does this by repeatedly    */
/*      calling "AddChar".                                                   */
/*                                                                           */
/*      Input(s):      Pointer to a C string (null-terminated array of       */
/*                     chars).                                               */
/*                                                                           */
/*      Output(s):     None                                                  */
/*                                                                           */
/*      Returns:       Pointer to start of string in string table            */
/*                                                                           */
/*---------------------------------------------------------------------------*/
